...
func InitConfig() error {
	...
	dbType := flag.String("db", Mysql, "the database type,mysql|sqlserver")
	...
	table := flag.String("table", "", "table,multiple tables ',' split, empty  is all")
	ignoreTable := flag.String("ignore_table", "", "ignore table,multiple tables ',' split")
	flag.Parse()
